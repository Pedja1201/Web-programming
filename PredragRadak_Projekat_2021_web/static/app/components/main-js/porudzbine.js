export default {
    template:`
<div class="w-75 p-3" v-if="stranicaZaPrikaz=='porudzbine'">
...
<button v-on:click="navigate('porudzbine')" type="button" class="btn btn-primary btn-lg btn-block">Prikaz porudžbine</button>
