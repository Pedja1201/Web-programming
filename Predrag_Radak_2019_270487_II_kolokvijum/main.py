...
def getIznajmljivanje(iznajmljivanje_id):
    ...
    if iznajmljivanje is not None:
        iznajmljivanje["cena"] = float(iznajmljivanje["cena"])  ##decimal
        return flask.jsonify(iznajmljivanje)
...
def izmeniIznajmljivanje(iznajmljivanje_id):
