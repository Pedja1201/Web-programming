export default {
    template:`
<div>
    <korisnik-form v-bind:naslov="'Dodaj korisnika'" v-bind:nike-shop="nikeShop" v-bind:automobil="automobil" v-on:sacuvaj="createKorisnik" v-bind:dugme="'Dodaj'"></korisnik-form>

    <tabela-korisnika v-bind:korisnici="korisnici" v-on:uklanjanje="removeKorisnik" v-on:izmena="setKorisnikZaIzmenu"></tabela-korisnika>
