export default {
    template:`
<button v-on:click="navigate('polisa')" type="button" class="btn btn-outline-danger btn-lg btn-block m-3">Dodavanje polise</button>

<div class="w-75 p-3" v-if="stranicaZaPrikaz=='polisa'">
